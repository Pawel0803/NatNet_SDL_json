...
if __name__ == "__main__":
    ...
    is_running = streaming_client.run(optionsDict["stream_type"]) # This line is for looking after first run
    if not is_running:
    ...
    for gtfile in gtCapFiles:
        filename, suffix = os.path.splitext(os.path.basename(gtfile))
